...
- [ ] !["in-progress" badge](https://img.shields.io/badge/in--progress-grey?style=flat) *strict* or *loose* validation of (incomming) requests payloads with automatic type casting to corresponding endpoint DTOs according to pre-defined [Zod](https://zod.dev/) schemas: `req.body`, `req.params`, `req.query` and `req.headers`
