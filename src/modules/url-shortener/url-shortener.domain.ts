...
export declare const UrlIdBrand: unique symbol;
...
export type UrlItemNoId = Omit<UrlItem, "id">;
export type UrlItemNoIdUpdate = Partial<UrlItemNoId>;

// ============================================================================
// Zod Request Schemas and Types - to be used with "zalidate(...)" function
// ============================================================================
...
/**
 * OpenApi Operation: Lists all URL items in the database.
 */
...
/**
 * OpenApi Operation: Gets a URL item from the database.
 */
...
/**
 * OpenApi Operation: Generate an ID and create/save a new URL item into the database.
 */
...
/**
 * OpenApi Operation: Delete an URL item from the database.
 */
export const deleteUrlItem: ZodOpenApiOperationObject = {
  operationId: "delete URL Item",
  summary: "Delete an URL item",
  description: "Delete an URL item from the database.",
  tags: ["URL Shortener"],
  requestParams: {
    path: z.object({ id: UrlIdSchema }),
  },
  responses: {
    204: {
      description: "The URL item has been successfully deleted.",
    },
    404: {
      description: "Not Found",
      content: { "application/json": { schema: ClientErrorSchema.meta({ example: "{ \"status\": \"error\", \"statuscode\": 404, \"message\": \"Not Found\"}" }) },
